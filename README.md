...
- [3.Survey](#3survey)
- [4.Other Useful Research](#4other-useful-research)
- [Reference](#reference)
...
|                                                       [A Semantic Invariant Robust Watermark for Large Language Models](https://arxiv.org/pdf/2310.06356)                                                       | ICLR-2024                  | Logits-Bias,Robustness,<br />Invisibility,Imperceptibility                       | Improve-[KGW](https://proceedings.mlr.press/v202/kirchenbauer23a/kirchenbauer23a.pdf),Generate a logits bias <br />based on semantics to add a watermark                                                                              | [https://github.com/THU-BPM/Robust_Watermark](https://github.com/THU-BPM/Robust_Watermark)                             |
|                                                                                                                                                                                                              |                            |                                                                                  |                                                                                                                                                                                                                                    |                                                                                                                     |
|                                                                                                                                                                                                              |                            |                                                                                  |                                                                                                                                                                                                                                    |                                                                                                                     |

# 3.Survey

| Paper                                                                                | Proceedings / Journal-Year |
| ------------------------------------------------------------------------------------ | -------------------------- |
| [A Survey on LLM-generated Text Detection: Necessity, Methods, and Future Directions]() | 2024                       |
|                                                                                      |                            |

# 4.Other Useful Research

| Paper                                                                                         | Proceedings / Journal-Year | Detail                                                                                                                     |
| --------------------------------------------------------------------------------------------- | -------------------------- | -------------------------------------------------------------------------------------------------------------------------- |
